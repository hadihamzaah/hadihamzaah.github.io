...
<html lang="en">
    ...
    <body>
        ...
        var overlaysTree = [
            {label: '<img src="legend/TITIK_BANJIR_4.png" /> TITIK_BANJIR', layer: layer_TITIK_BANJIR_4},
            {label: '<img src="legend/CILIWUNG_3.png" /> CILIWUNG', layer: layer_CILIWUNG_3},
            {label: '<img src="legend/CISADANE_2.png" /> CISADANE', layer: layer_CISADANE_2},
            {label: 'POTTENSI_BANJIR_KAWASAN_SELATAN_KOTA_BOGOR<br /><table><tr><td style="text-align: center;"><img src="legend/POTTENSI_BANJIR_KAWASAN_SELATAN_KOTA_BOGOR_1_Rendah0.png" /></td><td>Rendah</td></tr><tr><td style="text-align: center;"><img src="legend/POTTENSI_BANJIR_KAWASAN_SELATAN_KOTA_BOGOR_1_Sedang1.png" /></td><td>Sedang</td></tr><tr><td style="text-align: center;"><img src="legend/POTTENSI_BANJIR_KAWASAN_SELATAN_KOTA_BOGOR_1_Tinggi2.png" /></td><td>Tinggi</td></tr><tr><td style="text-align: center;"><img src="legend/POTTENSI_BANJIR_KAWASAN_SELATAN_KOTA_BOGOR_1_3.png" /></td><td></td></tr></table>', layer: layer_POTTENSI_BANJIR_KAWASAN_SELATAN_KOTA_BOGOR_1},
        ...
        map.addControl(new L.Control.Search({
            layer: layer_POTTENSI_BANJIR_KAWASAN_SELATAN_KOTA_BOGOR_1,
            initial: false,
